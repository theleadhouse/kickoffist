...
const GROUPS=[
  ...
  {id:"J",teams:[{t:"Argentina",f:"🇦🇷",p:2,pts:6},{t:"Austria",f:"🇦🇹",p:2,pts:3},{t:"Jordan",f:"🇯🇴",p:1,pts:0},{t:"Algeria",f:"🇩🇿",p:1,pts:0}]},
      ...
      <div className="card" style={{overflow:"hidden"}}>
        {GROUPS.map(({id,teams},gi)=>(
          <div key={id} style={{borderTop:gi>0?"1px solid rgba(255,255,255,.05)":"none"}}>
            <div style={{display:"flex",justifyContent:"space-between",padding:"5px 10px",background:"rgba(255,153,51,.04)"}}>
            ...
            {teams.map((t,i)=>(
              <div key={t.t} className="st-row">
                ...
                <span style={{fontFamily:"'Barlow Condensed','Oswald',sans-serif",fontSize:"13px",fontWeight:900,width:"20px",textAlign:"center",
