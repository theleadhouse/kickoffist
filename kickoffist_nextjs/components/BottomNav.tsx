...
export default function BottomNav() {
  ...
  return (
    <nav style={{position:"fixed",bottom:0,left:0,right:0,zIndex:50,background:"rgba(17,19,24,.98)",backdropFilter:"blur(20px)",borderTop:"1px solid rgba(255,153,51,.15)",display:"flex",boxShadow:"0 -4px 20px rgba(0,0,0,.5)"}} className="sm:hidden">
      {NAV.map(item => {
