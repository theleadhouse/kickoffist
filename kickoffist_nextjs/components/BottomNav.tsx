...
export default function BottomNav(){
  ...
  return(
    <nav style={{position:"fixed",bottom:0,left:0,right:0,zIndex:50,background:"rgba(4,8,4,.98)",backdropFilter:"blur(20px)",borderTop:"2px solid rgba(255,153,51,.15)",display:"flex"}} className="sm:hidden">
      {NAV.map(item=>{
