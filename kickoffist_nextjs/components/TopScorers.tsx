...
export default function TopScorers(){
  return(
    <div>
      <div className="sh"><span className="sh-saff">⚽ GOLDEN BOOT</span><div className="sh-line"/><span style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:"9px",fontWeight:700,color:"rgba(255,255,255,.2)",letterSpacing:".06em"}}>JUN 27</span></div>
      <div className="glass" style={{borderRadius:"12px",overflow:"hidden"}}>
        {S.map((s,i)=>(
          <div key={s.n+i} style={{display:"flex",alignItems:"center",gap:"8px",padding:"9px 14px",borderBottom:"1px solid rgba(255,255,255,.05)"}}>
        ...
        <div style={{padding:"6px 14px",borderTop:"1px solid rgba(255,255,255,.06)",fontFamily:"'Barlow Condensed',sans-serif",fontSize:"9px",fontWeight:700,color:"rgba(255,255,255,.18)",textAlign:"center",letterSpacing:".06em"}}>🐐 MESSI 18 CAREER WC GOALS · ALL-TIME RECORD</div>
      </div>
    </div>
  );
}
