const S=[
  ...
  {n:"Ronaldo", t:"Portugal",    f:"🇵🇹",g:4},
  {n:"Kane",    t:"England",     f:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",g:4},
  {n:"Oyarzabal",t:"Spain",      f:"🇪🇸",g:2},
...
export default function TopScorers(){
  return(
    <div>
      <div className="sh">⚽ GOLDEN BOOT<div className="sh-line"/><span style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:"9px",fontWeight:700,color:"rgba(255,255,255,.25)"}}>JUL 3</span></div>
        ...
        {S.map((s,i)=>(
          <div key={s.n+i} style={{display:"flex",alignItems:"center",gap:"8px",padding:"9px 14px",borderBottom:"1px solid rgba(255,255,255,.04)"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:"2px",flexShrink:0}}>
              <span style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"21px",letterSpacing:"1px",color:i===0?"#FF9933":i<3?"#fff":"rgba(255,255,255,.4)"}}>{s.g}</span>
